...
const buttonType = {
  ...
  purpleToPink:
    "text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center",
  pinkToOrange:
  ...
  pinkToBlue:
    "text-white bg-gradient-to-br from-pink-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center",
  tealToLime:
...
<button {disabled} class={buttonType.purpleToBlue} on:click={onClick} {...$$restProps}>
  <slot />
</button>
